...
export function DocumentUpload({ onFilesUploaded, isLoading }: DocumentUploadProps) {
  ...
  return (
    <div className="rounded-lg shadow-lg p-8" style={{ backgroundColor: '#040b13' }}>
            ...
            {oldFile ? (
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  ...
                  <div>
                    <p className="text-sm font-medium text-black">{oldFile.name}</p>
            ...
            {newFile ? (
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <File className="h-8 w-8 text-green-500 mr-3" />
                  <div>
                    <p className="text-sm font-medium text-black">{newFile.name}</p>
                    <p className="text-xs text-gray-600">
